...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnAlarmManager).setOnClickListener(this);
    ...
    private void runAlarmManager() {
        ...
        alrmMgr.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 1000, alarmIntent);

        Toast.makeText(this, "Wait... 1 sec", Toast.LENGTH_SHORT).show();
    }
    ...
    private void runJobDispatcher() {
        ...
        Job myJob = dispatcher.newJobBuilder()
                ...
                .setTag("Job firebase")        // uniquely identifies the job
